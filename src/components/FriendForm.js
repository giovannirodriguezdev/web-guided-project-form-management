    ...
    <form className='form container' onSubmit={onSubmit}>
      <div className='form-group inputs'>
        ...
        <label>Username
          ...
          <input type='text' name='username' placeholder='Type a username:' value={values.username} onChange={onChange}></input>
        </label>

        <label>Email
          {/* 🔥 STEP 4 - Make an input of type `email` or `text` for email. */}
            <input type='email' name='email' placeholder='Type your email' value={values.email} onChange={onChange}></input>
        </label>
